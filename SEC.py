...
def get_info2(num, input_url):
    ...
    # Initializing the counter for keeping track of rows
    i = 1
    # for tr in br.find_all("tr"):
    #     if len(tr) != 3:
    #         continue
    #     for td in tr.find_all("td"):
    #         if "Release No" in td.get_text() or "Date" in td.get_text() or "Respondents" in td.get_text():
    #             continue
    #
...
#Find everything from 1995 to 2015, inclusive.
...
get_info2(2016, "https://www.sec.gov/litigation/litreleases/litrelarchive/litarchive2016.shtml")
